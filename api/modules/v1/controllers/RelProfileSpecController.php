...
use app\models\RelProfileSpec;
use app\models\Profile;


class RelProfileSpecController extends ActiveController
{
 
    public $modelClass = 'app\models\RelProfileSpec';
    ...
    {
        $model = RelProfileSpec::findById($id);
        $profile = Profile::findByUid(Yii::$app->user->getId());
